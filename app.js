(function () {
  ...
  function getBaseUrl() {
    ...
    return last === href.length - 1 ? href : href.substring(0, last + 1);
  }
  var modelPath = config.modelPath || 'assets/model.glb';
  ...
  function initThree(videoElement) {
    ...
    var loadTimeout = setTimeout(function () {
      ...
      if (modelLoadingEl) {
        modelLoadingEl.innerHTML = 'Модель не загрузилась. <br><a href="' + GLB_PATH + '" target="_blank" rel="noopener" style="color:#eab676;">Откройте эту ссылку</a> — если 404, файла нет на сервере. Файл: webar/assets/model.glb';
